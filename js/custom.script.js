    ...
    $(function(){
        ...
        $('.images-bg').each(function(){
            if($(window).width() > 420 && $(window).width() < 768){
                $('img', this).hide();
                $(this).css({
                    'background-image': 'url(img/header/mob_slide736_'+count1+'.jpg)',
                ...
                $('img', this).hide();
                $(this).css({
                    'background-image': 'url(img/header/mob_slide'+count+'.jpg)',
                    'height': $(window).height(),
                    'background-position':'inherit'
                });
            } else {
        ...
        $('.main-navi').on('click', '#showHideMenu', function(){
            ...
            if($('.left-menu').hasClass('animate')){
                ...
                $('.main-navi').css('margin-right', "10px");
            }else{
            ...
            $.ajax({
                ...
                success: function(msg) {
                    ...
                    if(msg == 'OK') {
						...
						$('#ajax-contact-form').html('<div class="notification_ok text-center" style="padding:20px 0 0; color:green;font-size:16px;">Your message has been sent. Thank you!</div>');
                    } else {
